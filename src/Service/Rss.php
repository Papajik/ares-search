...
class Rss
{
    ...
    public function createXml(array $items): string
    {
        ...
        $channel->addChild('link', Http::isSecure() ? "https" : "http" . '://www.' . $_SERVER['SERVER_NAME'] . '/rss');
        ...
        foreach ($items as $address) {
            ...
            $item->addChild('link', Http::isSecure() ? "https" : "http" . '://www.' . $_SERVER['SERVER_NAME'] . '/address?id=' . $address->getId());
